...
# Build Supplier box                    
subgraph cluster1 {
S [style = filled, fillcolor = grey, shape = rectangle, fontsize = 11, label = 'Supplier'];
...
# Build Input box
subgraph cluster2 {
I [style = filled, fillcolor = grey, shape = rectangle, fontsize = 11, label = 'Input'];
...
# Build Outcome box
subgraph cluster4 {
O [style = filled, fillcolor = grey, shape = rectangle, fontsize = 11, label = 'Output'];
...
# Build Customer box
subgraph cluster5 {
C [style = filled, fillcolor = grey, shape = rectangle, fontsize = 11, label = 'Customer'];
